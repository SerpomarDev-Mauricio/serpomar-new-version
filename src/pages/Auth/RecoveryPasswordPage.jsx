...
// --- RecoveryPasswordPage Component ---
...
const RecoveryPasswordPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative z-20 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-md transform transition-all duration-500 ease-in-out p-8">
