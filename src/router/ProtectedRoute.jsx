...
const ProtectedRoute = ({ requiredRoles, redirectPath="/" }) => {
  // const hasRole = [].includes; // Función para verificar roles, puedes ajustarla según tu lógica
  const isAutenticated = authService.isAuthenticated(); // Obtiene el usuario y la función hasRole del contexto
